...
export const de = {
  ...
  credits: {
    ...
    topupsSumMonth: "Gesamtaufladungen (Monat)",
    topupsSumPaid: "Bezahlt über Stripe (Monat)",
    topupsSumFree: "Gratis-Guthaben (Monat)",
  ...
  admin: {
    ...
    lettersToday: "Briefe eingeliefert (heute)",
    lettersMonth: "Briefe eingeliefert (Monat)",
    activeJobs: "Aktive Sendungen",
    topupRevenue: "Aufladungen gesamt (Monat)",
    topupSplitHint: (paid: string, free: string) =>
      `Bezahlt (Stripe): ${paid} · Gratis-Guthaben: ${free}`,
    ...
    queueJobs: "Interne Job-Queue (offen)",
    queueJobsHint: "Technische Verarbeitungsjobs – nicht die aktiven Sendungen.",
