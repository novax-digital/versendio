...
| I-011 | Builder-Ausbau: Drag-and-Drop-Sortierung (dnd-kit, inkl. Inverse-Scale-Modifier für den skalierten Canvas), Inline-Formatierung (fett im Absatz), freie Akzentfarbe, mm-genaue Seitenumbruch-Marker, Mobile-Bearbeitung (Bottom-Sheet ≥16px) | runderes Builder-Erlebnis | mittel | Builder v2, 2026-07-10 |
...
| I-015 | Dirty-Guard auch für In-App-Navigation (Router-Intercept), nicht nur beforeunload | kein Datenverlust über Sidebar-Links | niedrig | Review Builder v2 |
| I-016 | Auto-Aufladung auf Stripe-Invoicing umstellen (Invoice-Item mit Tax Rate statt PaymentIntent), damit auch Auto-Topups eine USt.-Rechnung erhalten | korrekter Steuerausweis für alle Zahlungen | mittel | B2B-Netto-Umstellung 2026-07-13 |
